...
class __TwigTemplate_11c30d37866bef3ba000ef1ad99dc075cab783aadb439fca36e1753a346c239d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<table class=\"data fullwidth\">
    {% for i in 1..limit %}
        <tr>
            <td>&nbsp;</td>
        </tr>
...
", "_components/widgets/Feed/body", "/var/www/dev.mavenshake.com/vendor/craftcms/cms/src/templates/_components/widgets/Feed/body.html");
    }
}
