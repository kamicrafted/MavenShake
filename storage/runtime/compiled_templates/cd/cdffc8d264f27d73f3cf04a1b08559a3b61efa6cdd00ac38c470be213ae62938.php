...
/* _includes/forms */
class __TwigTemplate_7cd0d57997a189f74b629cbe7d527a3aeeca98875637453342d850a8e47ac0d8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_password($__config__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 20
            echo "    ";
            $this->loadTemplate("_includes/forms/text", "_includes/forms", 20)->display(twig_to_array(twig_array_merge((isset($context["config"]) || array_key_exists("config", $context) ? $context["config"] : (function () { throw new RuntimeError('Variable "config" does not exist.', 20, $this->source); })()), ["type" => "password"])));
            // line 0
    ...
    ";
            ...
            ";
                ...
                if ((isset($context["instructions"]) || array_key_exists("instructions", $context) ? $context["instructions"] : (function () { throw new RuntimeError('Variable "instructions" does not exist.', 191, $this->source); })())) {
                    ...
                    echo call_user_func_array($this->env->getFilter('md')->getCallable(), [(isset($context["instructions"]) || array_key_exists("instructions", $context) ? $context["instructions"] : (function () { throw new RuntimeError('Variable "instructions" does not exist.', 192, $this->source); })())]);
                    echo "</div>
            ";
                }
                // line 194
    ...
    public function macro_lightswitchField($__config__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (( !craft\helpers\Template::attribute($this->env, $this->source, ($context["config"] ?? null), "labelId", [], "any", true, true) ||  !craft\helpers\Template::attribute($this->env, $this->source, (isset($context["config"]) || array_key_exists("config", $context) ? $context["config"] : (function () { throw new RuntimeError('Variable "config" does not exist.', 228, $this->source); })()), "labelId", []))) {
                // line 229
                echo "        ";
                $context["config"] = twig_array_merge((isset($context["config"]) || array_key_exists("config", $context) ? $context["config"] : (function () { throw new RuntimeError('Variable "config" does not exist.', 229, $this->source); })()), ["labelId" => ("label" . twig_random($this->env))]);
                // line 230
                echo "    ";
            }
            // line 231
    ...
    ";
            ...
            if ((((craft\helpers\Template::attribute($this->env, $this->source, ($context["config"] ?? null), "suggestEnvVars", [], "any", true, true) &&  !(null === craft\helpers\Template::attribute($this->env, $this->source, ($context["config"] ?? null), "suggestEnvVars", [])))) ? (craft\helpers\Template::attribute($this->env, $this->source, ($context["config"] ?? null), "suggestEnvVars", [])) : (false))) {
                ...
                if (( !craft\helpers\Template::attribute($this->env, $this->source, ($context["config"] ?? null), "tip", [], "any", true, true) && !twig_in_filter(twig_slice($this->env, (isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 255, $this->source); })()), 0, 1), [0 => "\$", 1 => "@"]))) {
                    // line 256
                    echo "            ";
                    $context["config"] = twig_array_merge((isset($context["config"]) || array_key_exists("config", $context) ? $context["config"] : (function () { throw new RuntimeError('Variable "config" does not exist.', 256, $this->source); })()), ["tip" => ((((((((craft\helpers\Template::attribute($this->env, $this->source,                     // line 257
...
{% macro optionShortcutLabel(key, shift, alt) %}
    ...
    {% endspaceless -%}
{% endmacro %}
", "_includes/forms", "/var/www/dev.mavenshake.com/vendor/craftcms/cms/src/templates/_includes/forms.html");
    }
}
