...
/* settings */
class __TwigTemplate_8e1b52d8b2a5a3949b88abc5859779a463e95e29f152a6420341917f5a19828a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    {% endfor %}
{% endblock %}
", "settings", "/var/www/dev.mavenshake.com/vendor/craftcms/cms/src/templates/settings/index.html");
    }
}
